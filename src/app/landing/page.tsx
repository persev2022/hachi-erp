    ...
    <div className="min-h-screen bg-white text-gray-900 overflow-x-hidden">
      ...
      <section id="platform" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div id="modules" className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            {/* Small cards */}
            {[
              { emoji: "💰", title: "Financeiro", desc: "Mensalidades, inadimplência, DRE, Pix e conta corrente." },
              { emoji: "👨‍👩‍👧", title: "Portal da Família", desc: "Acompanhamento do tratamento e pagamento via Pix." },
              { emoji: "📄", title: "Documentos", desc: "Contratos, receitas e recibos gerados em 30 segundos." },
              { emoji: "💬", title: "WhatsApp", desc: "Cobranças, lembretes e fluxos via BotConversa." },
              { emoji: "🔒", title: "Segurança", desc: "AES-256, RBAC, 2FA, audit log e LGPD compliance." },
            ].map((card) => (
      ...
      <footer className="py-8 px-6 border-t border-gray-100 bg-white">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/images/hachi-logo.png" alt="Hachi" className="h-7 w-7 rounded-md invert" />
