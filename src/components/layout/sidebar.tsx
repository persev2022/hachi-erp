...
const navigation: NavItem[] = [
  ...
  { name: "Indicadores", href: "/indicadores", icon: PieChart, roles: ["ADMIN", "FINANCEIRO", "COORDENADOR"], feature: "relatorios" },
  { name: "Escalas", href: "/escalas", icon: CalendarCheck, roles: ["ADMIN", "COORDENADOR", "ENFERMEIRO", "MONITOR"], feature: "agenda" },
